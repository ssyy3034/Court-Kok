...
| **권동하** | **Frontend**        | - 회원가입 및 로그인 페이지 UI/UX 개발<br>- JWT 인증 로직 클라이언트 연동<br>- 마이페이지 및 사용자 정보 관련 프론트엔드 개발                                                                                       | **[ssyy3034](https://github.com/ssyy3034)**     |
| **유선목** | **Backend & Infra** | - Flask 기반 API 서버 및 비즈니스 로직 개발<br>- MongoDB 데이터베이스 스키마 설계<br>- **WebSocket 서버 구축 및 실시간 기능 개발**<br>- AWS, Docker 기반의 인프라 설계 및 구축<br>- GitHub Actions를 통한 CI/CD 파이프라인 자동화 | **[tjsahr9191](https://github.com/tjsahr9191)** |
